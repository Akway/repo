...
{
	$clean[$i]=trim(substr("$value", -1));
	$i++;
}
$numero=array_values(array_filter($clean));
...
//recuperation de la reponde dans out2.txt
...
$path="https://www.newbiecontest.org/epreuves/prog/verifprsudoku.php?solution=".$reponse;
